...
L'utilisation d'un tel modèle hiérarchique dans ce cas peut s'expliquer par le fait que le poids d'un rat dépend de plusieurs facteurs. En effet on peut imaginer que le poids du rat varie en fonction du rat lui-même (par exemple en fonction de son sexe), en fonction de son alimentation ou encore en fonction de son environnement. Plus de détails sur l'expérience aurait pu nous indiquer les informations exactes pour ce modèle hiérarchique. 
